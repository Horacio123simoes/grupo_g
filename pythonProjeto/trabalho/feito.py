"""1###---------------------------------------------------------------------------------------------------------------//
###Sistema de cadastro para o banco simoes em listas -- Python --
###--------------------------------------------------------------------------------------------------------------//
        ...
        while ok1:
            ...
            if menuCliente == '1':
                ...
                if numClientes < 50:
                    ...
                    cc = int(input("Informe o numero da conta corrente do cliente: "))
            ...
            if menuCliente == '2':
                ...
                if consultarV == True:
                    ...
                    print("{0} \t {1} \t {2} \t {3} \t {4}".format(Clientes['cod'][pos], Clientes['nome'][pos],
                                                                   Clientes['tel'][pos], Clientes['cc'][pos],
                                                                   Contas['saldo'][pos]))
